  ...
  return (
    <div className="max-w-sm mx-auto rounded-xl shadow-md overflow-hidden border border-gray-200">
      ...
      <div className="p-4 text-center bg-white">
        ...
        <p className="text-sm text-gray-500 mt-1">At 90ft road, Thakurli, Dombivli East <span className="text-gray-400">By</span> <span className="font-medium text-gray-700">SS Lifespaces</span></p>
        <div className="mt-4 bg-gray-100 p-3 rounded-md text-left text-sm">
          <p><span className="font-semibold text-gray-700">About:</span> <span className="font-bold">28 Storey</span></p>
          <p><span className="font-semibold text-gray-700">Rera No:</span> <span className="font-bold">P51700026395</span></p>
          <p><span className="font-semibold text-gray-700">Tower:</span> <span className="font-bold">Tower 4</span></p>
        </div>
